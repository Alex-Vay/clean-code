...
public class MdTests
{
    ...
    [TestCase("___пересечения___", "___пересечения___", TestName = "ShouldHandleMixedUnmatchedTagsInOneWord")]
    ...
    [TestCase("_ff _ ff_", "<em>ff _ ff</em>", TestName = "ShouldIgnoreTagWithoutSymbol")]
